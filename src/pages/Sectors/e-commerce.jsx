...
export default function EcommercePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Optimized E-commerce Logistics & Retail Supply Chain Solutions | MRSSupplyChain</title>
        <meta name="description" content="Discover efficient logistics solutions for e-commerce and retail sectors with MRSSupplyChain." />
        <meta name="keywords" content="E-commerce Logistics, Retail Supply Chain, Online Retail Warehousing, Fast Retail Delivery, Efficient E-commerce Transport" />
      </Helmet>
