...
export default function RenewableEnergyPage() {
  ...
  return (
    ...
    <Helmet>
      <title>Comprehensive Logistics for Renewable Energy & Infrastructure Projects | MRSSupplyChain</title>
      <meta name="description" content="Trust MRSSupplyChain for efficient logistics solutions tailored for renewable energy and infrastructure projects." />
      <meta name="keywords" content="Renewable Energy Logistics, Infrastructure Supply Chain, Logistics for Renewable Projects, Efficient Infrastructure Transport, Supply Chain for Energy Projects" />
    </Helmet>
