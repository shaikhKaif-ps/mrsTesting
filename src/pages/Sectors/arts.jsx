...
export default function ArtsPage() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Secure Logistics for Luxury Goods & Art Exhibitions | MRSSupplyChain</title>
        <meta name="description" content="Explore secure logistics solutions for luxury goods and art exhibitions with MRSSupplyChain." />
        <meta name="keywords" content="Luxury Goods Logistics, Art Exhibitions Transport, Secure Logistics for Luxury Items, Exhibition Goods Warehousing, High-Value Item Logistics" />
      </Helmet> 
