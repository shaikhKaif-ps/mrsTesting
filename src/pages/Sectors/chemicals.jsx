...
export default function chemicalsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Integrated Logistics Solutions for Chemicals, Construction, Energy, & Agriculture | MRSSupplyChain</title>
        <meta name="description" content="Explore comprehensive logistics solutions for chemicals, construction, energy, and agriculture sectors with MRSSupplyChain." />
        <meta name="keywords" content="Chemical Logistics, Construction Supply Chain, Energy Logistics, Agricultural Goods Transport, Hazardous Cargo Warehousing" />
      </Helmet>
