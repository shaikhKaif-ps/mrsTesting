...
import Warehousing_Solution from '../../../../assets/img/sectors_img/arts/ArtsExhibitions.jpg'
...
export default function SectorSpotlight () {
    ...
    return (
        <>
        <div className="service-spotlight custom-brokerage-sec section inner-spotlight-sec section-padd-LR overflow arts-hdr" >
            <div className="main-container width-1250 flex">
                <div className="inner-spot-clm-1" id='inner-spot-clm-1'>
                    ...
                    <h1 className="js-split-text white">Arts, Exhibitions, and <br />Luxury Goods </h1>                    
                    <img src={Line} alt="Line" data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="300"/>
                    <p className="white" data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="300">Elevating the Art of Luxury Logistics</p>
                    ...
                    <div className="btn inner-spt-btn white" data-aos="fade-in" data-aos-duration="1000" data-aos-once="true" data-aos-delay="300">
                        ...
                        <a className='white-60'>Arts, Exhibitions, and Luxury Goods</a>
                    </div>
