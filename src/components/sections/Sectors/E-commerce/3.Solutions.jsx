            ...
            <div className="main-container width-1250 built-to-suit-container1">     
                ...
                <div className='row built-row T-B-Padding B-padding-o '>
                    <div className='clm-2 solution-clm'>   
                        ...
                        <p data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="">Innovative delivery solutions that address the fast-paced demands of e-commerce and retail, ensuring timely and accurate delivery to the end customer.</p>
                        <h3 data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="">Duty-Free Warehousing</h3>
                        <p data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="">Flexible warehousing solutions that support the diverse storage and distribution needs of the retail sector, from inventory management to order fulfilment.</p>                    
                    </div>
