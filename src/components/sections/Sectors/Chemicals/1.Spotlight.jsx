...
export default function SectorSpotlight () {
    ...
    return (
        <>
        <div className="service-spotlight custom-brokerage-sec section inner-spotlight-sec section-padd-LR overflow chemical-hdr" >
            <div className="main-container width-1250 flex">
                <div className="inner-spot-clm-1 width-50" id='inner-spot-clm-1'>
                    ...
                    <p className="white" data-aos="fade-in" data-aos-duration="600" data-aos-once="true" data-aos-delay="300">Navigating the Complexities of Bulk Logistics in Key Economic Sectors</p>
                    ...
                    <div className="btn inner-spt-btn white" data-aos="fade-in" data-aos-duration="1000" data-aos-once="true" data-aos-delay="300">
                        ...
                        <a className='white-60'>Agriculture, Chemicals, Construction, Energy</a>
                    </div>
                </div>                
            </div>
