...
export default function HomeSector () {
    ...
    return (
        <>            
            <div className="sector-sec section-padd-LR" id="sector">
                <div className="main-container"> 
                    <div className="ovrflw-hdn">
                        <h2 className="sectr-ttl black js-split-text">Key Sectors we work with</h2>         
                    </div>    
                        <div className="swiper sector-sldr" data-aos="fade-in"  data-aos-duration="1000" data-aos-once="true"  data-aos-delay="700"> 
                             <div className="pegination-arrow2">
                                    <div className="sector-swiper-button-next cursor">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none"><g opacity="0.9"><path d="M12 20H28" stroke="#929292" strokeLinecap="round" /><path d="M21 12L29 20L21 28" stroke="#929292" strokeLinecap="round"/>    <circle cx="20.5" cy="20.5" r="20" transform="matrix(-1 0 0 1 41 0)" stroke="#929292"/></g></svg>
                                    </div>
                                    <div className="sector-swiper-button-prev cursor">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none"><g opacity="0.9"><path d="M29 20H13" stroke="#929292" strokeLinecap="round"/><path d="M20 12L12 20L20 28" stroke="#929292" strokeLinecap="round"/>    <circle cx="20.5" cy="20.5" r="20" stroke="#929292"/></g></svg>                              
                                    </div>
                            </div>
                                    ...
                                    <div className="sector-bx">
                                        ...
                                        <div className="content-dv">
                                            ...
                                            <div className="inner-content-dv">
                                                ...
                                                <a className="btn grey" id="btn-styl" href="/sector/industrial-sector"><span className="btn_name">Read more</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
