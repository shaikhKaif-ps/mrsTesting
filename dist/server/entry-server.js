...
const postsData = [
  {
    ...
    short_description: "Solar energy logistics in India explained: import compliance, Mundra Port, Grade A warehousing, FTWZ, and inland transport for solar projects.",
    content: `
    ...
    metaDescription: "How solar modules are imported, cleared, warehoused and moved from Mundra port to project sites across India — and how to cut duty, damage and delay.",
    imgAltTag: "Solar Energy Logistics in India: The Complete Guide | MRS Supply Chain",
    ogImage: "https://www.mrssupplychain.com/Blog_img/solar-energy-logistics-in-india.png",
    schema: {
      "@context": "https://schema.org",
      "@type": "Article",
      headline: "Solar Energy Logistics in India: The Complete Guide",
      description: "How solar modules are imported, cleared, warehoused and moved from Mundra port to project sites across India — and how to cut duty, damage and delay.",
      image: "https://www.mrssupplychain.com/Blog_img/solar-energy-logistics-in-india.png",
...
As global commerce continues to evolve, MRS Supply Chain remains committed to enabling smarter, faster, and more resilient trade through strategic warehousing solutions.
  ...
  },
  {
    ...
    short_description: "Optimize fast moving consumer goods logistics with MRS Supply Chain—achieve speed, scalability, and efficiency with modern warehousing and FTWZ solutions.",
    content: `
  ...
  },
  {
    ...
    short_description: "Learn how FTWZ simplifies importing medical devices into India with duty benefits, compliance support, and Grade A warehousing by MRS Supply Chain.",
    content: `
  ...
  `,
    category: "Blog",
    featureImage: "Blog_img/importing-medical-devices-into-india-ftwz-logistics-guide.webp",
    metaTitle: "Importing Medical Devices into India | FTWZ and Logistics Guide",
    metaDescription: "Learn how FTWZ simplifies importing medical devices into India with duty benefits, compliance support, and Grade A warehousing by MRS Supply Chain.",
    imgAltTag: "Importing Medical Devices into India | FTWZ and Logistics Guide",
    ogImage: "path/to/og-image.jpg",
    schema: {
      "@context": "https://schema.org",
      "@type": "Article",
      headline: "Importing Medical Devices into India | FTWZ and Logistics Guide",
      description: "Learn how FTWZ simplifies importing medical devices into India with duty benefits, compliance support, and Grade A warehousing by MRS Supply Chain.",
      image: "path/to/schema-image.jpg"
    },
  ...
  },
  {
    ...
    short_description: "Discover how MRS Supply Chain’s end-to-end integrated logistics and 4PL services deliver visibility, coordination, and strategic control beyond traditional 3PL models.",
    content: `
...
When logistics complexity begins to impact efficiency, cost control, or internal bandwidth.
    ...
    metaTitle: "Beyond 3PL: Strategic Value of Integrated Logistics & 4PL | MRS Supply Chain",
    metaDescription: "Discover how MRS Supply Chain’s end-to-end integrated logistics and 4PL services deliver visibility, coordination, and strategic control beyond traditional 3PL models.",
    imgAltTag: "Beyond 3PL: Strategic Value of Integrated Logistics & 4PL | MRS Supply Chain",
    ogImage: "path/to/og-image.jpg",
    schema: {
      "@context": "https://schema.org",
      "@type": "Article",
      headline: "Beyond 3PL: Strategic Value of Integrated Logistics & 4PL | MRS Supply Chain",
      description: "Discover how MRS Supply Chain’s end-to-end integrated logistics and 4PL services deliver visibility, coordination, and strategic control beyond traditional 3PL models.",
      image: "path/to/schema-image.jpg"
    },
  ...
  },
  {
    ...
    title: "Navigating the Global Maze: How MRS Supply Chain Masters Customs, SEZ Rules, and Exim Trade Compliance",
    short_description: "Learn how MRS Supply Chain expertly navigates customs, SEZ rules, and export‑import trade compliance to support seamless global logistics and regulatory adherence.",
    content: `
            <p>
...
<p>
 ...
 provides the necessary key to unlock global markets; complex customs regulations and trade barriers become logistical challenges overcome through specialized knowledge and unwavering adherence to global standards.
           ...
           `,
    category: "Blog",
    featureImage: "Blog_img/customs-sez-exim-trade-compliance-mrs-supply-chain.png",
    metaTitle: "Mastering Customs, SEZ Rules & Exim Trade Compliance | MRS Supply Chain",
    metaDescription: "Learn how MRS Supply Chain expertly navigates customs, SEZ rules, and export‑import trade compliance to support seamless global logistics and regulatory adherence.",
    imgAltTag: "Mastering Customs, SEZ Rules & Exim Trade Compliance | MRS Supply Chain",
    ogImage: "path/to/og-image.jpg",
    schema: {
      "@context": "https://schema.org",
      "@type": "Article",
      headline: "Mastering Customs, SEZ Rules & Exim Trade Compliance | MRS Supply Chain",
      description: "Learn how MRS Supply Chain expertly navigates customs, SEZ rules, and export‑import trade compliance to support seamless global logistics and regulatory adherence.",
      image: "path/to/schema-image.jpg"
    },
